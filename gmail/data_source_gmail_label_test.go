		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.gmail_label.chat", "background_color", defaultLabelBackgroundColor),
					resource.TestCheckResourceAttr("data.gmail_label.chat", "text_color", defaultLabelTextColor),
					...
					resource.TestCheckResourceAttr("data.gmail_label.sent", "background_color", defaultLabelBackgroundColor),
					resource.TestCheckResourceAttr("data.gmail_label.sent", "text_color", defaultLabelTextColor),
					...
					resource.TestCheckResourceAttr("data.gmail_label.inbox", "background_color", defaultLabelBackgroundColor),
					resource.TestCheckResourceAttr("data.gmail_label.inbox", "text_color", defaultLabelTextColor),
					...
					resource.TestCheckResourceAttr("data.gmail_label.important", "background_color", defaultLabelBackgroundColor),
					resource.TestCheckResourceAttr("data.gmail_label.important", "text_color", defaultLabelTextColor),
					...
					resource.TestCheckResourceAttr("data.gmail_label.trash", "background_color", defaultLabelBackgroundColor),
					resource.TestCheckResourceAttr("data.gmail_label.trash", "text_color", defaultLabelTextColor),
					...
					resource.TestCheckResourceAttr("data.gmail_label.draft", "background_color", defaultLabelBackgroundColor),
					resource.TestCheckResourceAttr("data.gmail_label.draft", "text_color", defaultLabelTextColor),
					...
					resource.TestCheckResourceAttr("data.gmail_label.spam", "background_color", defaultLabelBackgroundColor),
					resource.TestCheckResourceAttr("data.gmail_label.spam", "text_color", defaultLabelTextColor),
					...
					resource.TestCheckResourceAttr("data.gmail_label.category_forums", "background_color", defaultLabelBackgroundColor),
					resource.TestCheckResourceAttr("data.gmail_label.category_forums", "text_color", defaultLabelTextColor),
					...
					resource.TestCheckResourceAttr("data.gmail_label.category_updates", "background_color", defaultLabelBackgroundColor),
					resource.TestCheckResourceAttr("data.gmail_label.category_updates", "text_color", defaultLabelTextColor),
					...
					resource.TestCheckResourceAttr("data.gmail_label.category_personal", "background_color", defaultLabelBackgroundColor),
					resource.TestCheckResourceAttr("data.gmail_label.category_personal", "text_color", defaultLabelTextColor),
					...
					resource.TestCheckResourceAttr("data.gmail_label.category_promotions", "background_color", defaultLabelBackgroundColor),
					resource.TestCheckResourceAttr("data.gmail_label.category_promotions", "text_color", defaultLabelTextColor),
					...
					resource.TestCheckResourceAttr("data.gmail_label.category_social", "background_color", defaultLabelBackgroundColor),
					resource.TestCheckResourceAttr("data.gmail_label.category_social", "text_color", defaultLabelTextColor),
					...
					resource.TestCheckResourceAttr("data.gmail_label.starred", "background_color", defaultLabelBackgroundColor),
					resource.TestCheckResourceAttr("data.gmail_label.starred", "text_color", defaultLabelTextColor),
					...
					resource.TestCheckResourceAttr("data.gmail_label.unread", "background_color", defaultLabelBackgroundColor),
					resource.TestCheckResourceAttr("data.gmail_label.unread", "text_color", defaultLabelTextColor),
